...
export default function Login() {
    const { windowWidth, windowHeight, isKeyboardVisible } = useLogin();
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} scrollEnabled={true}>
                <KeyboardAvoidingView style={{ flex: 1, alignItems: 'center' }}>
                    ...
                    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <TextInput placeholder="E-mail" placeholderTextColor="#7C7C8A" style={{ width: 278, height: 56, color: 'white', backgroundColor: '#121214', borderRadius: 6 }}></TextInput>
                        <TextInput placeholder="Senha" placeholderTextColor="#7C7C8A" style={{ width: 278, height: 56, color: 'white', backgroundColor: '#121214', borderRadius: 6 }}></TextInput>
                        <TouchableOpacity>
                    ...
                    <View style={{ flex: 1, justifyContent: 'flex-end', alignItems: 'center' }}>
                        ...
                        <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 15, marginBottom: 10 }}>Ainda não tem acesso ?</Text>
