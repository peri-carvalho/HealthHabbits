import { SafeAreaView, View, Dimensions, KeyboardAvoidingView, Text, TextInput, Button, TouchableOpacity, ScrollView } from "react-native";
...
export default function SignUp() {
    const { windowWidth, windowHeight, isKeyboardVisible, handleSignUp, goBack } = useSignUp();
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} scrollEnabled={true}>
                <KeyboardAvoidingView style={{ flex: 1, alignItems: 'center' }}>
                    ...
                    <View style={{ height:windowHeight*0.6, alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <TextInput placeholder="Nome" placeholderTextColor="#7C7C8A" style={{ width: 278, height: 56, color: 'white', backgroundColor: '#121214', borderRadius: 6, paddingLeft: 16 }}></TextInput>
                        <TextInput placeholder="E-mail" placeholderTextColor="#7C7C8A" style={{ width: 278, height: 56, color: 'white', backgroundColor: '#121214', borderRadius: 6, paddingLeft: 16 }}></TextInput>
                        <TextInput placeholder="Senha" placeholderTextColor="#7C7C8A" style={{ width: 278, height: 56, color: 'white', backgroundColor: '#121214', borderRadius: 6, paddingLeft: 16 }}></TextInput>
                        <TextInput placeholder="Confirme a Senha" placeholderTextColor="#7C7C8A" style={{ width: 278, height: 56, color: 'white', backgroundColor: '#121214', borderRadius: 6, paddingLeft: 16 }}></TextInput>
