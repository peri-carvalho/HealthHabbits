          ...
          >
            ...
            >
              ...
              <TouchableOpacity onPress={() => goAchievements()}>
                <Text
                  style={{ fontSize: 17, color: "white", fontWeight: "500" }}
                >
                  Conquistas
                </Text>
              </TouchableOpacity>
            ...
            <TouchableOpacity onPress={() => setSelectionCategory(item.id)}>
              <View
                style={{
                  ...
                  alignItems: "center",
                  marginLeft: 18,
                  borderWidth: selectionCategory === item.id ? 1 : 0,
                  borderColor:
                    selectionCategory === item.id ? "#79A532" : "#202024",
                }}
              >
                <Text
                  style={{
                    fontSize: 10,
                    color: selectionCategory === item.id ? "#79A532" : "white",
                  }}
                >
                  {item.name}
                </Text>
        ...
        <View style={{ width: windowWidth * 0.85, alignItems: "center" }}>
          ...
          <View style={{ alignItems: "center", justifyContent: "center" }}>
            <FlatList
              ...
              renderItem={({ item }) =>
                // Mostra o item se for da categoria selecionada OU se a categoria for '1' (todas)
                selectionCategory === 1 ||
                selectionCategory === item.idCategory ? (
                  <TouchableOpacity
                    onPress={() =>
                      goHabit(
                        item.id,
                    ...
                    >
                      <View
                        style={{
                          ...
                          justifyContent: "space-between",
                          alignItems: "center", // **vírgula adicionada aqui**
                          flexDirection: "row", // **assembly correction**
                        }}
                      >
                        <View style={{ flexDirection: "row", width: 200 }}>
                          <SvgXml
                            xml={image_type(item.type)}
                            width={67}
                            height={67}
                          />
                          <View
